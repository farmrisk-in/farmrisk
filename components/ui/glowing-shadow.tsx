...
export function GlowingShadow({ children, loading = false }: GlowingShadowProps) {
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .glow-container.hover-fixed .glow-content {
        ...
        .glow-container.hover-fixed .glow-content:before {
          --bg-size: 15;
        ...
        .glow-container.hover-fixed .glow {
          --glow-blur: 1.5;
          --glow-opacity: 0.6;
          --glow-scale: 2.5;
          --glow-radius: 0;
        ...
        .glow-container.hover-fixed .glow:after {
          --glow-translate-y: 0;
          animation-play-state: paused;
      ...
      <div className={`glow-container ${!loading ? "hover-fixed" : ""}`} role="button">
